             ...
             void       *ccache)	/* I - Kerberos credentials or NULL */
{
  ...
  printf("[cert.c:cupsdAddCert()] adding certificate for pid %d\n", pid);
  ...
  */
  ...
  printf("[cert.c:cupsdAddCert()] opening cert file %s\n", filename);
...
#  endif /* HAVE_MBR_UID_TO_UUID */
  ...
  printf("[cert.c:cupsdAddCert()] adding certificate pid=%d, username=%s, cert=%s\n", pid, username,
	 cert->certificate);
  ...
  */
  ...
  printf("[cert.c:cupsdAddCert()] done\n");
}
...
cupsdInitCerts(void)
{
  ...
  printf("[cert.c:cupsdInitCerts()] called\n");
  ...
  */
  ...
  printf("[cert.c:cupsdInitCerts()] seed = %x\n", seed);
  srandom(seed);
  ...
  */
  ...
  if (!RunUser) {
    printf("[cert.c:cupsdInitCerts()] adding certificate\n");
    cupsdAddCert(0, "root", NULL);
  }

  printf("[cert.c:cupsdInitCerts()] done\n");
