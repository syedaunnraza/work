...
echo "[$currenttime] Running First Instance of Cron (to termination)..."

(LD_LIBRARY_PATH=/usr/lib/debug/ /home/syed/Workspace/Pin/pin -t /home/syed/Workspace/Pin/source/tools/DebugTrace/obj-ia32/debugtrace.so -o "$1" -sys 0 -pid 0 -stat 0 -time 0 -netinit 0 -epoll 0 -devrand 0 -rdtsc 0 -canary 0 -guard 0 -leader 1 -timefile "$3/time.txt" -dayfile "$3/day.txt" -print_func 0 -sysfile "$3/sys1.txt" -epollfile "$3/epoll.txt" -memory 1 -fix_fork 0 -cpuid 0 -atraddr 0xbffff46b -- /usr/sbin/cron -f) > "$3/output1.txt" 

#(LD_LIBRARY_PATH=/usr/lib/debug/ /home/syed/Workspace/Pin/pin -t /home/syed/Workspace/Pin/source/tools/DebugTrace/obj-ia32/debugtrace.so -o "$1" -sys 1 -pid 1 -stat 1 -time 1 -netinit 0 -epoll 0 -devrand 1 -rdtsc 1 -canary 1 -guard 1 -leader 1 -timefile "$3/time.txt" -dayfile "$3/day.txt" -print_func 1 -sysfile "$3/sys1.txt" -epollfile "$3/epoll.txt" -memory 1 -fix_fork 1 -cpuid 1 -atraddr 0xbffff46b -- /usr/sbin/cron -f) > "$3/output1.txt" 
...
currenttime=$(date +"%D %I:%M:%S %P")
echo "[$currenttime] Running Second Instance of Cron (to termination)..."

(LD_LIBRARY_PATH=/usr/lib/debug/ /home/syed/Workspace/Pin/pin -t /home/syed/Workspace/Pin/source/tools/DebugTrace/obj-ia32/debugtrace.so -o "$2" -sys 0 -pid 0 -stat 0 -time 0 -netinit 0 -epoll 0 -devrand 0 -rdtsc 0 -canary 0 -guard 0 -leader 0 -timefile "$3/time.txt" -dayfile "$3/day.txt" -print_func 0 -sysfile "$3/sys2.txt" -epollfile "$3/epoll.txt" -memory 1 -atraddr 0xbffff46b -cpuid 0 -fix_fork 0 -- /usr/sbin/cron -f) > "$3/output2.txt" 

#(LD_LIBRARY_PATH=/usr/lib/debug/ /home/syed/Workspace/Pin/pin -t /home/syed/Workspace/Pin/source/tools/DebugTrace/obj-ia32/debugtrace.so -o "$2" -sys 1 -pid 1 -stat 1 -time 1 -netinit 0 -epoll 0 -devrand 1 -rdtsc 1 -canary 1 -guard 1 -leader 0 -timefile "$3/time.txt" -dayfile "$3/day.txt" -print_func 1 -sysfile "$3/sys2.txt" -epollfile "$3/epoll.txt" -memory 1 -atraddr 0xbffff46b -cpuid 1 -fix_fork 1 -- /usr/sbin/cron -f) > "$3/output2.txt" 
