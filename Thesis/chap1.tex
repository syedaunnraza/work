...
\section{Motivation}
Several companies (including Dropbox\cite{dbox} and Netflix\cite{ntflix}) have successfully
used server virtualization in data centers to reduce operating costs, improve performance scalability 
and simplify management. In light of the significant benefits 
of server virtualization, many companies are now looking to apply the same technology 
to their desktop computers.

Virtual Desktop Infrastructure (VDI) allows organizations to
outsource their desktop machines
