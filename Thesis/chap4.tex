...
%It then waits for all silhouettes
...
The notion of whether two distinct execution strands can be reconciled
...
From our data collection scheme, we already compute the 
